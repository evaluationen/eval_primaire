<div class="container">
    ...
    <div class="row">
        <form method="post" action="<?php echo site_url('qbank/edit_question/8/' . $question['qid']); ?>">
...
foreach ($options as $key => $val) {	
    ?>
                            <div class="form-group">	 
                                <label for="inputEmail"  ><?php //echo $this->lang->line('options'); ?> <?php echo 'Case N°['. ($key+1) .']'; ?></label> <br>
                                <input type="checkbox" name="score[]" value="<?php echo $key; ?>" <?php if ($val['score'] >= 0.1) {
                            echo 'checked';
                        } ?> > Select Correct Option 
                                <br><textarea  name="option[]"  class="form-control" style="display: none"><?php echo $val['q_option']; ?></textarea>
                            </div>
    <?php
}
?>
