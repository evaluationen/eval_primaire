...
<div class="container">
    ...
    <div class="row">
        <form method="post" action="<?php echo site_url('student/new_student'); ?>">
                ...
                <div class="/*login-panel panel panel-default*/">
                    <div class="panel-body"> 
                        ...
                        <div class="form-group">	 
                            ...
                            <input type="text" required=""  name="last_name"  class="form-control" placeholder="<?php echo $this->lang->line('last_name'); ?>"   autofocus>
                        </div>
                        <div class="form-group">	 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="datepicker form-control" placeholder="<?php echo $this->lang->line('birth'); ?>" name="birth" /> <span style="color:#abc"><b>(format : jj/mm/aaaa)</b></span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="eid" >
                                <?php foreach ($school_list as $key => $val) :?>
                                    <option value="<?php echo $val->eid; ?>"><?php echo  '['. $val->rne_etab.'] ' . $val->etab ; ?></option>
                                    <?php endforeach;  ?>
                            </select>        
                        </div>
                        
                        <!--div class="form-group">	 
                            <label for="inputEmail" class="sr-only"><?php //echo $this->lang->line('email'); ?></label> 
                            <input type="email" id="inputEmail" name="email" class="form-control" placeholder="<?php echo $this->lang->line('email'); ?>"  autofocus><!--required-->
                        </div-->
