                ...
                <div class="login-panel panel panel-default">
                    <div class="panel-body"> 
                        ...
                        <div class="form-group">	 
                            ...
                            <input type="radio" name="view_answer"    value="1" <?php
                            if ($quiz['view_answer'] == 1) {
                                echo 'checked';
                            }
                            ?>  > <?php echo $this->lang->line('yes'); ?>&nbsp;&nbsp;&nbsp;
                            <input type="radio" name="view_answer"    value="0"   <?php
                            if ($quiz['view_answer'] == 0) {
                                echo 'checked';
                            }
...
if ($this->config->item('webcam') == true) {
    ?>
                            <div class="form-group">	 
                                ...
                                <input type="radio" name="camera_req"    value="1"   <?php
                                       if ($quiz['camera_req'] == 1) {
                                           echo 'checked';
                                       }
                                       ?>  > <?php echo $this->lang->line('yes'); ?>&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="camera_req"    value="0"   <?php
    ...
    ?>
                        ...
                        <div class="form-group">	 
                            <label   ><?php echo $this->lang->line('select_group'); ?></label> <br>
                                ...
                                <input type="checkbox" name="gids[]" value="<?php echo $val['gid']; ?>" <?php
                                       if (in_array($val['gid'], explode(',', $quiz['gids']))) {
                                           echo 'checked';
                                       }
                        ...
                        <div class="form-group">	 
                            <label   ><?php echo $this->lang->line('select_class'); ?></label> <br>
    ...
    <?php foreach ($val['class'] as $cl) : ?>
            ...
            echo 'checked';
                        ...
                        <div class="form-group">	 
                            ...
                            if ($quiz['gen_certificate'] == 1) {
                                echo 'checked';
                            }
                                   ?> > <?php echo $this->lang->line('yes'); ?><br>
                            <input type="radio" name="gen_certificate"    value="0"    <?php
                            if ($quiz['gen_certificate'] == 0) {
                                echo 'checked';
                            }
                                   ?> > <?php echo $this->lang->line('no'); ?>
                        </div>
                        ...
                        <br><br><br>
                            ...
                            <table class="table table-bordered" style="margin-top:10px;">
                                <tr>
                                    ...
                                    <th><?php echo $this->lang->line('coef'); ?></th>
    ...
    if (count($questions) == 0) {
        ...
        ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" style="width: 50px" name="coef_<?php echo $val['qid']; ?>" value="<?php echo isset($questions_coef[$val['qid']]->coef) ? $questions_coef[$val['qid']]->coef : 1 ?>"/></td>
                                        <td>

                                            <a href="<?php echo site_url('quiz/remove_qid/' . $quiz['quid'] . '/' . $val['qid']); ?>" title="<?php echo $this->lang->line('remove_from_quiz'); ?>"><img src="<?php echo base_url('ressources/images/cross.png'); ?>"></a>
                                            <?php
                                            if ($key == 0) {
                                                ?>
                                                <img src="<?php echo base_url(); ?>ressources/images/empty.png" title="">
            <?php
        } else {
            ?>
                                                <a href="javascript:cancelmove('Up','<?php echo $quiz['quid']; ?>','<?php echo $val['qid']; ?>','<?php echo $key + 1; ?>');"><img src="<?php echo base_url(); ?>ressources/images/up.png" title="<?php echo $this->lang->line('up'); ?>"></a>
                                        <?php
                                    }
                                    ...
                                    ?>
                                                <a href="javascript:cancelmove('Down','<?php echo $quiz['quid']; ?>','<?php echo $val['qid']; ?>','<?php echo $key + 1; ?>');"><img src="<?php echo base_url(); ?>ressources/images/down.png" title="<?php echo $this->lang->line('down'); ?>"></a>
                                    <?php
                                }
                                ?>
                                        </td>
    ...
    ?>
        ...
        foreach ($level_list as $key => $val) {
            ?>
                                            ...
                                            <option value="<?php echo $val['lid']; ?>"   <?php
                                    if ($val['lid'] == $vall['lid']) {
                                        echo 'selected';
                                    }
