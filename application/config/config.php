...
$config['user_registration']=false;//desactive registration by user
...
$config['result_message'] = "Bonjour, <br> \r\n \r\n  voici le resultat de  <b>[last_name] [first_name]<b>, <br> Statut : [result_status] <br> Quiz: '[quiz_name]' <br> et  Pourcentage obtenu : [percentage_obtained]% . <br> [result_certificat] <br><br> Pour voir plus d'infos, merci de se connecter sur le portail Quiz. <br><br>Cordialement";
$config['result_subject'] = "Resultat généé pour le  quiz [quiz_name]";



// email send from
$config['fromemail']="noreply@ac-mayotte.fr";
// from name
$config['fromname']="Administrator - Evaluate Portal";
